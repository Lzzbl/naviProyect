<?php
// Ejemplo de API en PHP para la tienda de patinetas (MySQL versión)
...
function createProduct($pdo) {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO products 
            (name, description, price, original_price, discount_percentage, image_url, category_id, brand_id, stock_quantity, sku) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
function updateProduct($pdo, $id) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE products 
                               SET name = ?, description = ?, price = ?, original_price = ?, discount_percentage = ?, image_url = ?, category_id = ?, brand_id = ?, stock_quantity = ?, updated_at = NOW() 
                               WHERE id = ?");
